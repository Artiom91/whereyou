...
class Workout {
    ...
    _setDescription() {
        this.type === 'running' ? this.description = `Пробежка ${new Intl.DateTimeFormat('ru-Ru').format(this.date)}` : 
...
class App {
    ...
    constructor () {
        ...
        btnReset.addEventListener('click', this._btnReset.bind(this))
    }
    ...
    _getPosition() {
        if (navigator.geolocation) {
            ...
            function(){
                alert('Невозможно получить ваше местоположения')
            }
            )
        }
    }
    ...
    _showForm(e) {
        ...
        inputDistance.focus()
        btnReset.classList.remove('form__btn')
    }
    ...
    _newWorkout(e) {
        ...
        this._displayWorkoutOnSlidebar(workout)
    ...
    _displayWorkoutOnSlidebar(workout) {
       let html = `
